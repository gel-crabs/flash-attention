...
torch::Tensor fwd_hip(
    torch::Tensor const& input, 
    torch::Tensor const& mask,
    float scale_factor);

torch::Tensor bwd_hip(
    torch::Tensor const& output_grads, 
    torch::Tensor const& softmax_results,
    float scale_factor);

int get_batch_per_block_hip(
    int query_seq_len,
    int key_seq_len,
    int batches,
    int attn_heads);
...
torch::Tensor fwd(
  ...
  return fwd_hip(input, mask, scale_factor);
}
...
torch::Tensor bwd(
  ...
  return bwd_hip(output_grads, softmax_results, scale_factor);
}
...
int get_batch_per_block(
    ...
    int batches,
    int attn_heads) {
    return get_batch_per_block_hip(query_seq_len, key_seq_len, batches, attn_heads);
}
...
torch::Tensor fwd(torch::Tensor const& input, float scale_factor) {
  ...
  return fwd_hip(input, scale_factor);
}
