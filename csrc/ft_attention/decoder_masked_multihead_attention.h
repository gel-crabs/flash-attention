...
#ifdef ENABLE_BF16
void masked_multihead_attention(const Masked_multihead_attention_params<hip_bfloat16>& params,
...
#ifdef ENABLE_BF16
void cross_multihead_attention(const Cross_multihead_attention_params<hip_bfloat16>& params,
                               const hipStream_t&                                    stream);
#endif
