...
#ifdef ENABLE_BF16
template<>
struct Qk_vec_<hip_bfloat16, 32> {
    using Type = __hip_bfloat162;
};
template<>
struct Qk_vec_<hip_bfloat16, 64> {
    using Type = __hip_bfloat162;
};
template<>
struct Qk_vec_<hip_bfloat16, 128> {
    using Type = bf16_4_t;
};
template<>
struct Qk_vec_<hip_bfloat16, 256> {
    using Type = bf16_8_t;
};
#endif  // ENABLE_BF16
////////////////////////////////////////////////////////////////////////////////////////////////////
...
#ifdef ENABLE_BF16
template<>
struct K_vec_<hip_bfloat16, 4> {
    using Type = __hip_bfloat162;
};
template<>
struct K_vec_<hip_bfloat16, 2> {
    using Type = bf16_4_t;
};
template<>
struct K_vec_<hip_bfloat16, 1> {
    using Type = bf16_8_t;
};
#endif  // ENABLE_BF16
////////////////////////////////////////////////////////////////////////////////////////////////////
...
#ifdef ENABLE_BF16
template<>
struct V_vec_<hip_bfloat16, 2> {
    using Type = __hip_bfloat162;
};
template<>
struct V_vec_<hip_bfloat16, 4> {
    using Type = bf16_4_t;
};
template<>
struct V_vec_<hip_bfloat16, 8> {
    using Type = bf16_8_t;
};
#endif  // ENABLE_BF16
////////////////////////////////////////////////////////////////////////////////////////////////////
...
template<>
struct Qk_vec_acum_fp32_<hip_bfloat16> {
    using Type = float;
};
template<>
struct Qk_vec_acum_fp32_<__hip_bfloat162> {
    using Type = float2;
};
template<>
...
template<>
struct K_vec_acum_fp32_<hip_bfloat16> {
    using Type = float;
};
template<>
struct K_vec_acum_fp32_<__hip_bfloat162> {
    using Type = float2;
};
template<>
...
{
#if defined(__HIP_ARCH__) && __HIP_ARCH__ >= 750
#ifdef MMHA_USE_FP32_ACUM_FOR_FMA
...
struct Qk_dot<uint16_t, 4> {
    ...
    {
#if __HIP_ARCH__ >= 750 && defined(MMHA_USE_HMMA_FOR_REDUCTION)
...
////////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef ENABLE_BF16
inline __device__ void convert_from_float(hip_bfloat16& dst, float src)
{
...
inline __device__ void convert_from_float(__hip_bfloat162& dst, float2 src)
{
...
#pragma unroll
    ...
    for (int ti = first_step + tidx; ti <= tlength; ti += THREADS_PER_BLOCK) {
        bool  is_mask = (params.masked_tokens != nullptr) && params.masked_tokens[bi_seq_len_offset + ti];
        float logit   = is_mask ? 0.f : expf(qk_smem[ti - first_step] - qk_max);
        sum += logit;
