...
#ifdef ENABLE_BF16
inline __device__ hip_bfloat16 add(hip_bfloat16 a, hip_bfloat16 b)
{
    return a + b;
}
...
#if 0 && defined(__HIP_ARCH__) && __HIP_ARCH__ >= 800  // Is it better?
  float zero = 0.f;
...
#ifdef ENABLE_BF16
inline __device__ float add(float a, hip_bfloat16 b)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef ENABLE_BF16
inline __device__ __hip_bfloat162 fma(__hip_bfloat162 a, __hip_bfloat162 b, __hip_bfloat162 c)
{
...
inline __device__ __hip_bfloat162 fma(hip_bfloat16 a, __hip_bfloat162 b, __hip_bfloat162 c)
{
...
inline __device__ bf16_4_t fma(hip_bfloat16 a, bf16_4_t b, bf16_4_t c)
{
...
inline __device__ bf16_8_t fma(hip_bfloat16 a, bf16_8_t b, bf16_8_t c)
{
    __hip_bfloat162 s = bf162bf162(a);
    bf16_8_t       d;
    d.x = fma(s, b.x, c.x);
...
inline __device__ float fma(hip_bfloat16 a, hip_bfloat16 b, float fc)
{
...
inline __device__ float2 fma(hip_bfloat16 a, __hip_bfloat162 b, float2 fc)
{
...
inline __device__ Float4_ fma(hip_bfloat16 a, bf16_4_t b, Float4_ fc)
{
    __hip_bfloat162 s = bf162bf162(a);
    Float4_        fd;
    fd.x = fma(s, b.x, fc.x);
...
inline __device__ Float8_ fma(hip_bfloat16 a, bf16_8_t b, Float8_ fc)
{
    __hip_bfloat162 s = bf162bf162(a);
    Float8_        fd;
    fd.x = fma(s, b.x, fc.x);
...
#ifdef ENABLE_BF16
template<>
inline __device__ hip_bfloat16 mul(hip_bfloat16 a, hip_bfloat16 b)
{
#if defined(__HIP_ARCH__) && __HIP_ARCH__ >= 800
    return __hmul(a, b);
#else
...
template<>
inline __device__ __hip_bfloat162 mul(hip_bfloat16 a, __hip_bfloat162 b)
{
...
template<>
inline __device__ bf16_4_t mul(hip_bfloat16 a, bf16_4_t b)
{
    __hip_bfloat162 s = bf162bf162(a);
    bf16_4_t       c;
...
template<>
inline __device__ bf16_8_t mul(hip_bfloat16 a, bf16_8_t b)
{
    __hip_bfloat162 s = bf162bf162(a);
    bf16_8_t       c;
    c.x = mul<__hip_bfloat162, __hip_bfloat162, __hip_bfloat162>(s, b.x);
...
template<>
inline __device__ float mul(hip_bfloat16 a, hip_bfloat16 b)
{
    float fa = (float)a;
    float fb = (float)b;
    return fa * fb;
...
template<>
inline __device__ float mul(hip_bfloat16 a, float b)
{
...
template<>
inline __device__ float2 mul(hip_bfloat16 a, __hip_bfloat162 b)
{
...
template<>
inline __device__ Float4_ mul(hip_bfloat16 a, bf16_4_t b)
{
    __hip_bfloat162 s = bf162bf162(a);
    Float4_        fc;
...
template<>
inline __device__ Float8_ mul(hip_bfloat16 a, bf16_8_t b)
{
    __hip_bfloat162 s = bf162bf162(a);
    Float8_        fc;
    fc.x = mul<float2, __hip_bfloat162, __hip_bfloat162>(s, b.x);
...
#ifdef ENABLE_BF16
inline __device__ __hip_bfloat162 rotary_embedding_transform(const __hip_bfloat162 v, const float2 coef)
{
...
#ifdef ENABLE_BF16
inline __device__ void apply_rotary_embedding(__hip_bfloat162& q, int tid, int rot_embed_dim, int t_step, const float base=10000.0f)
{
    if (2 * tid >= rot_embed_dim) {
        return;
    }
...
inline __device__ void apply_rotary_embedding(__hip_bfloat162& q, __hip_bfloat162& k, int tid, int rot_embed_dim, int t_step, const float base=10000.0f)
{
    if (2 * tid >= rot_embed_dim) {
        return;
    }
...
#ifdef ENABLE_BF16
inline __device__ void apply_rotary_embedding(__hip_bfloat162& q, int tid, int rot_embed_dim, int t_step, const hip_bfloat16* rotary_cos, const hip_bfloat16* rotary_sin)
{
    if (2 * tid >= rot_embed_dim) {
        return;
    }
...
inline __device__ void apply_rotary_embedding(__hip_bfloat162& q, __hip_bfloat162& k, int tid, int rot_embed_dim, int t_step, const hip_bfloat16* rotary_cos, const hip_bfloat16* rotary_sin)
{
    if (2 * tid >= rot_embed_dim) {
        return;
    }
...
inline __device__ void apply_rotary_embedding(bf16_4_t& q, int tid, int rot_embed_dim, int t_step, const hip_bfloat16* rotary_cos, const hip_bfloat16* rotary_sin)
{
    if (4 * tid >= rot_embed_dim) {
        return;
    }
...
inline __device__ void apply_rotary_embedding(bf16_4_t& q, bf16_4_t& k, int tid, int rot_embed_dim, int t_step, const hip_bfloat16* rotary_cos, const hip_bfloat16* rotary_sin)
{
    if (4 * tid >= rot_embed_dim) {
        return;
    }
...
inline __device__ void apply_rotary_embedding(bf16_8_t& q, int tid, int rot_embed_dim, int t_step, const hip_bfloat16* rotary_cos, const hip_bfloat16* rotary_sin)
{
    if (8 * tid >= rot_embed_dim) {
        return;
    }
...
inline __device__ void apply_rotary_embedding(bf16_8_t& q, bf16_8_t& k, int tid, int rot_embed_dim, int t_step, const hip_bfloat16* rotary_cos, const hip_bfloat16* rotary_sin)
{
    if (8 * tid >= rot_embed_dim) {
        return;
    }
...
vec_from_smem_transpose(bf16_4_t& vec, hip_bfloat16* smem, int transpose_idx, int smem_pitch)
{
    union {
        uint32_t      u32;
        hip_bfloat16 bf16[2];
    ...
    vec.x = __hip_bfloat162{tmp_1.bf16[0], tmp_2.bf16[0]};
    vec.y = __hip_bfloat162{tmp_1.bf16[1], tmp_2.bf16[1]};
}

template<>
__device__ __inline__ void
vec_from_smem_transpose(bf16_8_t& vec, hip_bfloat16* smem, int transpose_idx, int smem_pitch)
{
    union {
        uint64_t      u64;
        hip_bfloat16 bf16[4];
    ...
    vec.x = __hip_bfloat162{tmp_1.bf16[0], tmp_2.bf16[0]};
    vec.y = __hip_bfloat162{tmp_1.bf16[1], tmp_2.bf16[1]};
    vec.z = __hip_bfloat162{tmp_1.bf16[2], tmp_2.bf16[2]};
    vec.w = __hip_bfloat162{tmp_1.bf16[3], tmp_2.bf16[3]};
}
#endif  // ENABLE_BF16
...
template<>
__device__ __inline__ void
vec_from_smem_transpose(__hip_bfloat162& vec, hip_bfloat16* smem, int transpose_idx, int smem_pitch)
{
    vec.x = smem[transpose_idx];
    vec.y = smem[smem_pitch + transpose_idx];
}
...
template<>
__device__ __inline__ void
write_smem_transpose(const __hip_bfloat162& vec, hip_bfloat16* smem, int transpose_idx, int smem_pitch)
{
    smem[transpose_idx]              = vec.x;
    smem[smem_pitch + transpose_idx] = vec.y;
}
...
template<>
__device__ __inline__ void
write_smem_transpose(const bf16_4_t& vec, hip_bfloat16* smem, int transpose_idx, int smem_pitch)
{
...
template<>
__device__ __inline__ void
write_smem_transpose(const bf16_8_t& vec, hip_bfloat16* smem, int transpose_idx, int smem_pitch)
{
