...
def build_for_rocm():
    ...
    if int(os.environ.get("FLASH_ATTENTION_INTERNAL_USE_RTN", 0)):
        ...
        print("RTZ IS USED")
    fa_sources = ["ln_api.cpp","ln_fwd_256.cpp","ln_fwd_512.cpp","ln_fwd_768.cpp",
            "ln_fwd_1024.cpp","ln_fwd_1280.cpp","ln_fwd_1536.cpp",
            "ln_fwd_2048.cpp","ln_fwd_2560.cpp","ln_fwd_3072.cpp",
            "ln_fwd_4096.cpp","ln_fwd_5120.cpp","ln_fwd_6144.cpp",
            "ln_fwd_7168.cpp","ln_fwd_8192.cpp","ln_parallel_fwd_256.cpp",
            "ln_parallel_fwd_512.cpp","ln_parallel_fwd_768.cpp",
            "ln_parallel_fwd_1024.cpp","ln_parallel_fwd_1280.cpp",
            "ln_parallel_fwd_1536.cpp","ln_parallel_fwd_2048.cpp",
            "ln_parallel_fwd_2560.cpp","ln_parallel_fwd_3072.cpp",
            "ln_parallel_fwd_4096.cpp","ln_parallel_fwd_5120.cpp",
            "ln_parallel_fwd_6144.cpp","ln_parallel_fwd_7168.cpp",
            "ln_parallel_fwd_8192.cpp",] #+ glob.glob("src/*.cpp")
    rename_cpp_to_hip(fa_sources)
    ext_modules.append(
        CUDAExtension(
            'dropout_layer_norm', ["ln_api.hip","ln_fwd_256.hip","ln_fwd_512.hip","ln_fwd_768.hip",
            "ln_fwd_1024.hip","ln_fwd_1280.hip","ln_fwd_1536.hip",
            "ln_fwd_2048.hip","ln_fwd_2560.hip","ln_fwd_3072.hip",
            "ln_fwd_4096.hip","ln_fwd_5120.hip","ln_fwd_6144.hip",
            "ln_fwd_7168.hip","ln_fwd_8192.hip","ln_parallel_fwd_256.hip",
            "ln_parallel_fwd_512.hip","ln_parallel_fwd_768.hip",
            "ln_parallel_fwd_1024.hip","ln_parallel_fwd_1280.hip",
            "ln_parallel_fwd_1536.hip","ln_parallel_fwd_2048.hip",
            "ln_parallel_fwd_2560.hip","ln_parallel_fwd_3072.hip",
            "ln_parallel_fwd_4096.hip","ln_parallel_fwd_5120.hip",
            "ln_parallel_fwd_6144.hip","ln_parallel_fwd_7168.hip",
            "ln_parallel_fwd_8192.hip",], #+ glob.glob("src/*.cpp")
